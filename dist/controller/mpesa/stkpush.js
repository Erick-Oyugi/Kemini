 ...
 */
export const handleSTKPushIntegration = async (req, res) => {
    const telemetryTimeline = [];
    try {
        const { environment, shortCode, callbackUrl, phoneNumber } = req.body;
        ...
        const stkResponse = await axios.post(`${baseUrl}/mpesa/stkpush/v1/processrequest`, stkRequestPayload, { headers: { Authorization: `Bearer ${oauthToken}` } });
